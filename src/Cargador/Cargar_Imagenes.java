...
public class Cargar_Imagenes {
    ...
    protected static final int TOTAL_IMAGENES=25;
    ...
    /**Imagen del mercado**/
    public static final int GRANJA=24;
    ...
    private Cargar_Imagenes() {
        ...
        ,"bowser","fuego","creditos","creditos_img","fondo_aldea","cuartel","centro","fondo1","soldado","mercado","granja"};
